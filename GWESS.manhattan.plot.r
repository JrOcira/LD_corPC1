GWESS.manhattan.plot <- function(bait,nb.chr,position_bait_genes,chr_bait_gene,statistic){
library(dplyr)
library(magrittr)
library(ggplot2)
...
png(paste0(getwd(),"/manhattan.plot.",statistic,".png"), width = 1000, height = 600)
print(q) 
dev.off()
